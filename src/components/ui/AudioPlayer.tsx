    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, var(--color-logo-primary) 0%, var(--color-logo-primary) ${progressPercent}%, var(--color-border) ${progressPercent}%, var(--color-border) 100%)`,
          }}
        />
