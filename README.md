...
speechless is a fork of the [Handy](https://github.com/cjpais/Handy) project. We are deeply grateful to [cjpais](https://github.com/cjpais) and the original contributors for building such a solid foundation.

speechless is a cross-platform desktop application built with Tauri (Rust + React/TypeScript) that provides simple, privacy-focused speech transcription. Press a shortcut, speak, and have your words appear in any text field—all without sending your voice to the cloud.

## Why speechless?

speechless was created to fill the gap for a truly open source, extensible speech-to-text tool.
...
3. **Release** and speechless processes your speech using CPU-optimized models
