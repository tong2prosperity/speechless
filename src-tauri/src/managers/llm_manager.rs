    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            LlmModelInfo {
                ...
                description: "Qwen3.5 4B model by Alibaba.".to_string(),
                repo_id: "unsloth/Qwen3.5-4B-GGUF".to_string(),
                file_name: "Qwen3.5-4B-Q4_1.gguf".to_string(),
                size_mb: 2600,
                is_downloaded: false,
            },
            LlmModelInfo {
                ...
                description: "Qwen3.5 2B model by Alibaba.".to_string(),
                repo_id: "unsloth/Qwen3.5-2B-GGUF".to_string(),
                file_name: "Qwen3.5-2B-Q4_1.gguf".to_string(),
                size_mb: 1600,
                is_downloaded: false,
            },
        ]
